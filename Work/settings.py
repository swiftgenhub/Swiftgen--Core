...
if DATABASE_URL:
    ...
    # Fallback to SQLite for development or if DATABASE_URL is not set
    DATABASES = {
        'default': {
...
# Set up email functionality using Gmail's SMTP server with credentials stored in environment variables
